...
electron-packager . "${APP_NAME}" --platform=${PLATFORM} --arch=${ARCH} --electronVersion=1.4.14 --app-version=1.4.0 --icon=assets/HotRunner.png --overwrite --out=./dist --ignore=${ignore_list} --enable-transparent-visuals
